function F = CCoLBP(img, s, r, config, mode)
...
% CCoLBP feature extraction of input image
...
% CCoLBP.m is based on CoALBP.m released by Copyright (C) 2011- Ryusuke Nosaka. 
